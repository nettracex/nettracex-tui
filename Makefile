...
LINUX_ARM64_TARGET := $(OUTPUT_DIR)/$(APP_NAME)-v$(VERSION)-linux-arm64
WINDOWS_AMD64_TARGET := $(OUTPUT_DIR)/$(APP_NAME)-v$(VERSION)-windows-amd64.exe
DARWIN_AMD64_TARGET := $(OUTPUT_DIR)/$(APP_NAME)-v$(VERSION)-darwin-amd64
DARWIN_ARM64_TARGET := $(OUTPUT_DIR)/$(APP_NAME)-v$(VERSION)-darwin-arm64
