...
echo ""
echo "✨ Features:"
echo "- Multi-platform builds (Linux, Windows, macOS - AMD64/ARM64)"
echo "- Proper version detection from Git tags"
echo "- No 'next' suffix in snapshot builds"
echo "- Automatic GitHub releases on tag push"
echo ""
echo "📋 Next steps:"
...
echo "- go install github.com/nettracex/nettracex-tui@latest"
echo "- Download binaries from GitHub releases"
echo "- Build from source with proper version detection"
echo ""
